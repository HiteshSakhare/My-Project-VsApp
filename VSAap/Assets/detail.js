...
fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2Cplayer&id='+video_id+'&Ks-_Mh1QhMc&key=AIzaSyD6Tf2zpMApXIH-fgLqon17_4CUr4oQi2U')
.then((res) =>{
    return res.json();
...
function getSuggestions(){
    fetch('https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&relatedToVideoId'+video_id+'&Ks-_Mh1QhMc&type=video&key=AIzaSyD6Tf2zpMApXIH-fgLqon17_4CUr4oQi2U')
    .then((res)=>{
        return res.json();
    }).then((data)=>{
        //console.log(data);
